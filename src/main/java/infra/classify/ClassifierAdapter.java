...
public class ClassifierAdapter<C, T> implements Classifier<C, T> {
  ...
  /**
   * Search for the {@link infra.classify.annotation.Classifier
  ...
  public final void setDelegate(Object delegate) {
    ...
    MethodInvoker invoker = MethodInvoker.forAnnotation(infra.classify.annotation.Classifier.class, delegate);
    if (invoker == null) {
      try {
